...
public class Game extends JPanel implements ActionListener, KeyListener, MouseListener {
	...
	/**
	 * initializes the Game screen with initial mouse position, borders, and one row of boxes
	 * generates 5 random patterns that apply to the Box rows
	 * @param screenSize
	 */
	...
	public void paintComponent(Graphics g) {
		...
		if (showTitleScreen) {
			...
			g.drawString("Score: " + getLevel(), (int) (Main.screenSize.getWidth() / 5.5),
			...
			g.setColor(Color.WHITE);
			g.setFont(new Font(Font.SANS_SERIF, Font.BOLD, (int) (Main.screenSize.getWidth() / 30)));
			g.drawString("Your Score: " + getLevel(), (int) (Main.screenSize.getWidth() / 6.5),
			...
			g.drawString("Press the space key to restart", (int) (Main.screenSize.getWidth() / 12),
	...
	public void howToPlay(Graphics g)
	  {
	    ...
	    g.drawString("*Click close to the ball in the direction",(int) (Main.screenSize.getWidth() / 30),
	        (int) (Main.screenSize.getHeight() / 4 +40));
	    g.drawString("you want the ball to go in order to hit the blocks",(int) (Main.screenSize.getWidth() / 30),
	        (int) (Main.screenSize.getHeight() / 4 + 80));
	    g.drawString("*The ball will hit the blocks",(int) (Main.screenSize.getWidth() / 30),
	        (int) (Main.screenSize.getHeight() / 4 +120));
	    g.drawString("with the damage of the level number",(int) (Main.screenSize.getWidth() / 30),
	        (int) (Main.screenSize.getHeight() / 4 +160));
	    g.drawString("*Prevent the blocks from reaching the ground.",(int) (Main.screenSize.getWidth() / 30),
